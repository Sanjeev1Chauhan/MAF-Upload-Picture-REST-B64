package com.san.mobile.photo.mobile.util;
...
public class RestCallerUtil {
    ...
    public String invokeREAD(String requestURI){
        return this.invokeSecuredRestRequest(RestServiceAdapter.REQUEST_TYPE_GET, requestURI, "");
    }
    ...
    private String invokeRestRequest(String httpMethod, String requestURI, String payload){
        ...
        restServiceAdapter.setConnectionName("REST-Public");
     ...
     * @return
     */
    private String invokeSecuredRestRequest(String httpMethod, String requestURI, String payload){
        ...
        //to http://127.0.0.1:7101/hrrest/resources/hrappsrvc . The connection has been created for this 
        //sample choosing File | New | From Gallery | General | Connections | URL connection from the JDeveloper menu
        restServiceAdapter.setConnectionName("REST-Fusion-HcmCore");
        ...
        restServiceAdapter.addRequestProperty("Accept", "application/json; charset=UTF-8");
        String base64 = null;
        String cred = "kverma@kbace.com" + ":" + "Kbace@001";
        /*try {
        ...
        base64 = (String)AdfmfContainerUtilities.invokeContainerJavaScriptFunction("Test",
